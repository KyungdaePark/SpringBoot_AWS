...
public class PostsApiControllerTest {
    ...
    @Test
    public void Posts_등록된다() throws Exception{ // Posts를 등록하는 테스트
        //given
        String title = "title_test";
        String content = "content_test";
        PostsSaveRequestDto requestDto = PostsSaveRequestDto.builder() //PostsSaveRequestDto : Request를 데이터베이스에 저장해주는 클래스
                .title(title)
                .content(content)
                .author("author")
                .build();
